...
const Notifications = () => {
    ...
    return (
        <div className='relative group/menu px-15'>
            ...
            <span
                className='relative after:absolute after:w-10 after:h-10 after:rounded-full text-foreground dark:text-muted-foreground hover:text-primary dark:hover:text-primary after:-top-1/2 hover:after:bg-lightprimary dark:hover:after:bg-lightprimary rounded-full flex justify-center items-center cursor-pointer group-hover/menu:after:bg-lightprimary group-hover/menu:text-primary'>
              <Icon icon='tabler:bell-ringing' height={20}/>
            </span>
                        <span
                            className='rounded-full absolute -end-[6px] -top-[5px] text-[10px] h-2 w-2 bg-primary flex justify-center items-center'></span>
                    </div>
                </DropdownMenuTrigger>
